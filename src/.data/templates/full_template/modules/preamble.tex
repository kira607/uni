...
\usepackage{cite}  % bibliography. docs: https://texdoc.org/serve/cite.pdf/0
...
\renewcommand\thefigure{\arabic{section}.\arabic{figure}}  % proper subsection pictures numbers
\usepackage{tabularx}  % ???
